import { Container, createStyles, Grid, Title, AppShell } from '@mantine/core';
...
const categoryData = [
  ...
  },
  {
    ...
    name: 'Female Shirts',
    imgUrl:
      'https://burst.shopifycdn.com/photos/womens-necklace-set.jpg?width=925&format=pjpg&exif=1&iptc=1',
  },
  {
    id: '5123',
    name: 'Female Shirts',
...
const Landing = () => {
  ...
  return (
    <AppShell fixed={false} header={<NavBar />} footer={<Footer />}>
