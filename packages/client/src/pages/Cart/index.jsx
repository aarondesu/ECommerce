...
const tableData = [
  { id: 1, item: 'Item 1', size: 'xs', img: '', qty: 1, price: 150 },
  { id: 2, item: 'Item 2', size: 's', img: '', qty: 2, price: 25 },
];
  ...
  const rows = tableData.map((data) => {
    ...
    return (
      <tr key={data.id}>
        ...
        <td className={classes.itemTotal}>${total}</td>
      </tr>
    );
  });
